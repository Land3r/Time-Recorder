<template>
  <q-card style="min-width: 30vw; max-width: 90vw;">
    <q-card-section class="bg-primary text-white">
      <div class="text-h6">{{$t('form.activity.edit.title')}}</div>
    </q-card-section>

    <q-card-section>
      <q-input
        :label="$t('form.activity.edit.namelabel')"
        v-model="form.name"
      ...
      <q-input
        :label="$t('form.activity.edit.labellabel')"
        v-model="form.label"
      ...
      <q-select
        use-input
        input-debounce="0"
        :label="$t('form.activity.edit.iconlabel')"
        v-model="form.icon"
    ...
    <q-card-actions class="bg-white" align="right">
      ...
      <q-btn flat :label="$t('buttons.edit')" class="text-primary float-right" @click="submit()" :v-close-dialog="isValid"/>
    </q-card-actions>
  </q-card>
</template>
